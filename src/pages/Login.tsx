    ...
    <div className='min-h-[calc(100vh-4rem)] flex items-center justify-center px-4'>
      <div className='w-full max-w-md'>
        <div className='text-center mb-8'>
          ...
          <p className='text-gray-600 dark:text-gray-400'>Sign in to continue racing</p>
        </div>

        <form
          onSubmit={handleSubmit}
          className='bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-8 space-y-5'
        >
          {error && (
